  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (field.minLength && field.minLength > 0 && value.length < field.minLength) {
        showError(field, name.charAt(0).toUpperCase() + name.slice(1) + ' must be at least ' + field.minLength + ' characters.');
        return false;
      }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '3ee62261-a052-443f-9145-0e7c3b16467d',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '3ee62261-a052-443f-9145-0e7c3b16467d';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '3ee62261-a052-443f-9145-0e7c3b16467d';
